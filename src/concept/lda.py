...
import os
import gensim
import concept.text_processor as preprocessing
import wordcloud
...
class Lda:
    ...
    def use_bertopic(self):
        ...
        topic_model = BERTopic(
            language="multilingual", calculate_probabilities=True, verbose=True, min_topic_size=2
        )
        dt = []
        for list_sentence in self.preprocessed_doc:
            new_sent = str()
...
if __name__ == "__main__":
    ...
    method = "gridsearch"
    filename = 'C:\Repo\ConceptVisDemo\save\speech.txt'
    # filename = 'C:\Repo\ConceptVisDemo\save\speech.txt'
    # filename = 'C:\Repo\ConceptVisDemo\save\AI and the Future Factory AI House Davos 2024.txt'    
    ...
    if method == "gridsearch":
        ...
        lda.gridsearch(limit=15, start=3, step=2)
